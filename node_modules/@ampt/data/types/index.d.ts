...
export type KeyValueMeta<T> = KeyValue<T> & Metadata

export type GetResponse<T> = T | undefined
export type GetResponseKeyValue<T> = KeyValue<T> | undefined
export type GetResponseMeta<T> = KeyValueMeta<T> | undefined
